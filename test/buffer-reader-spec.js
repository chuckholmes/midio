describe("Midio.BufferReader", function () {

  it("It should read Int8", function () {
    var input = [-127, 127];
  ...
  it("It should read Uint8", function () {
    var input = [0, 255];
  ...
  it("It should read Int16", function () {
  ...
  it("It should read Uint16", function () {
    var input = [0, 65, 534];
    var view = new DataView(new ArrayBuffer(4));
  ...
  it("It should read Int32", function () {
  ...
  it("It should read Uint32", function () {
  ...
  it("It should read Float32", function () {
    var input = [0, 10];
    var view = new DataView(new ArrayBuffer(8));
  ...
  it("It should read Float64", function () {
    var input = [1, 10];
  ...
  it('It should read VarInt', function () {
    var input = 160000;
  ...
  it("It should read String", function () {
